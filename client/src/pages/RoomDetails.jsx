        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
          ...
          p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
              ...
              <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-poitner'>
                Check Availability 
              </button>    
          </form>
          ...
          <div className='mt-25 space-y-4'>
            ...
            <div className='flex flex-col items-start gap-4'>
              <div className='flex gap-4'>
                ...
                <button className="px-6 py-2.5 mt-4 rounded bg-blue-600 text-white hover:bg-blue-700 transition-all cursor-pointer">
                  Contact Now
                </button>
            </div>
        </div>
